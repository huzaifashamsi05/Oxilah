      ...
      <AnimatePresence>
        {mobileMenuOpen && (
          <motion.div
            ...
            className="fixed inset-y-0 right-0 w-64 bg-background-secondary shadow-2xl z-40 flex flex-col pt-24 px-6 md:hidden border-l border-white/10"
          >
            <nav className="flex flex-col space-y-6">
              ...
              <div className="pt-4">
                <Link
                  href="/contact"
                  onClick={() => setMobileMenuOpen(false)}
                  className="block text-center px-6 py-3 rounded-full bg-gradient-to-r from-accent-primary to-accent-secondary text-white font-medium"
                >
                  Get Started
                </Link>
              </div>
